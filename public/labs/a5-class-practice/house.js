...
function renderStudentsWithJQuery(students) {
  const studentElement = $('#jstudents')
  for(let k = 0 ; k < students.length; k++) {
    const lineItem = $(`<li>${students[k].name}</li>`)
    studentElement.append(lineItem)
  }
}
...
lab.append(`
    ...
    <h2>JSON Object Redux</h2>
    Rooms: <span id="room">3</span> <br/>
    Baths: <span id="baths">2</span> <br/>
    Sqft: <span id="sqft">1500</span> <br/>
`)